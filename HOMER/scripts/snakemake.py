...
rule all:
  input:
      expand("../results/{experiment}/peaks_motifOutput_{sample}/homerResults/motif1.motif1", experiment=EXPERIMENT, sample=SAMPLES)
...
rule run_find_motifs:
  input:
      ...
      expand("{path}{experiment}/exomePeaks_views/{sample}/peak.bed", path=PATH, experiment=EXPERIMENT, sample=SAMPLES)
  output:
      "../results/{experiment}/peaks_motifOutput_{sample}/homerResults/motif1.motif1"
  shell:
